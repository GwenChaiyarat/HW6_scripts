...
sudo curl https://raw.githubusercontent.com/GwenChaiyarat/AzureVM/main/default | sudo tee -a /etc/nginx/sites-available/default
...
sudo git clone https://github.com/GwenChaiyarat/HW6_website.git
